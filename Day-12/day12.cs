...
{
	public abstract class Vehicle			// Abstract Class must have atleast one abstract method 
	{
		public string name;
		public Vehicle(string n){
			name = n;
		}
		public abstract void ShowInfo();	// Abstract methods should only be defined by the child class
	}
	...
	public class Program
	{
		public static void Main(string[] args){
			//Vehicle v1 = new Vehicle("Buggatti", 380);		// Abstract Class can't be instantiated
